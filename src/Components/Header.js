...
const Header = () => {
  ...
  return (
    <div className="absolute w-screen px-8 py-2 bg-gradient-to-b from-black z-30 flex flex-col md:flex-row justify-between text-white">
      ...
      {user && (
        <div className="flex p-2 justify-between ">
          ...
          <img src={user?.photoURL} alt="user-icon" className="w-12 h-12 hidden md:block" />
